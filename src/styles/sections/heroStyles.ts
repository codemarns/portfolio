export const heroStyles = {
  ...
  column: {
    left: {
      ...
      image: {
        base: "p-8 before:content-[''] before:absolute before:inset-3 before:bg-secondary/10 before:rounded-full after:content-[''] after:absolute after:inset-0 after:border-2 after:border-secondary/30 after:rounded-full",
      },
    },
    right: {
