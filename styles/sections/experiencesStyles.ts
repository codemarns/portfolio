export const experiencesStyles = {
  ...
  trophy: {
    rope: {
      base: "absolute left-1/2 sm:left-8 lg:left-1/2 transform -translate-x-1/2 h-full w-1 bg-darker duration-300 ease-in-out transition-all",
    },
    circle: {
  ...
  experiences: {
    ...
    container: {
      base: "relative h-full p-6 sm:p-8 grid grid-cols-1 gap-5 text-left bg-darker rounded-xl shadow-lg",
    },
    info: {
      base: "grid grid-cols-1 gap-2",
      daterange: {
        base: "opacity-50 text-sm",
      },
      company: {
